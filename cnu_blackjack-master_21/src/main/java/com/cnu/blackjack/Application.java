        ...
        */
        ...
        do {
            ...
            for (String PlayerName : game.getPlayerList().keySet()) {
                System.out.printf(PlayerName + "의 배팅 금액을 입력하세요 : ");
            ...
            for (String PlayerName : game.getPlayerList().keySet()) {
                    ...
                    game.getPlayerList().get(PlayerName).getHand().getCardList().clear();
                    game.getPlayerList().get(PlayerName).setIsStay(false);
            }
